...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2b3d2931f8215d309708012c289d2060) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_annotations", []))];
          ...
          ("test_graph",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_graph", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_ddg",
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$test_transform", ["-runner"; "sequential"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$test_semantics", ["-runner"; "sequential"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_oratio",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_oratio", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_ate",
          ...
          ("test_ast_eval",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ast_eval", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["Emma Tosch"];
          homepage = Some "http://kdl-umass.github.io/planalyzer";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Statically analyzes PlanOut scripts, computing propensity scores, assessing between vs. within subjects analyses, and generating causal estimators."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/etosch/PlanAlyzer.git";
                      src_repo_browser =
                        Some "https://github.com/etosch/PlanAlyzer";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Utils"; "Logging"; "Performance"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "planalyzer.ml"});
               Library
                 ({
                     cs_name = "oratio";
                     cs_data = PropList.Data.create ();
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "planalyzer/annotations";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           FindlibPackage ("fieldslib", None);
                           InternalLibrary "oratio";
                           FindlibPackage ("ppx_deriving.make", None);
                           FindlibPackage ("ppx_deriving.show", None);
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "planalyzer/corepo";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "annotations";
                           InternalLibrary "graphs";
                           InternalLibrary "oratio";
                           FindlibPackage ("ppx_deriving.make", None);
                           FindlibPackage ("ppx_sexp_conv", None);
                           FindlibPackage ("sexplib", None);
                   ...
                   {
                      lib_modules = ["Corepo"; "Exceptions"; "Smtlib"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "planalyzer/estimators";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "corepo";
                           FindlibPackage ("dolog", None);
                           InternalLibrary "graphs"
                        ];
                      bs_build_tools =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "estimators";
                           InternalLibrary "planout";
                           FindlibPackage ("ppx_sexp_conv", None);
                           FindlibPackage ("sexplib", None)
                        ];
                      bs_build_tools =
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_utils.ml"});
               Executable
                 ({
                     cs_name = "test_ate";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_ate.ml"});
               Executable
                 ({
                     cs_name = "test_oratio";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_oratio.ml"});
               Executable
                 ({
                     cs_name = "test_annotations";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_annotations.ml"
                   });
               Executable
                 ({
                     cs_name = "test_graph";
                   ...
                   {exec_custom = false; exec_main_is = "test_graph.ml"});
               Executable
                 ({
                     cs_name = "test_ddg";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_ddg.ml"});
               Executable
                 ({
                     cs_name = "test_cgm";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_cgm.ml"});
               Executable
                 ({
                     cs_name = "test_ast_aux";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_ast_aux.ml"});
               Executable
                 ({
                     cs_name = "test_ast_normalize";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_ast_normalize.ml"
                   });
               Executable
                 ({
                     cs_name = "test_ast_parse";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_ast_parse.ml"});
               Executable
                 ({
                     cs_name = "test_transform";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_transform.ml"});
               Executable
                 ({
                     cs_name = "test_semantics";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_semantics.ml"});
               Executable
                 ({
                     cs_name = "test_ast_eval";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_ast_eval.ml"});
               Test
                 ({
                     cs_name = "test_annotations";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           ExternalTool "ocamldoc";
                           ExternalTool "ocamldebug";
                           InternalExecutable "test_annotations"
                        ]
                   });
               Test
                 ({
     ...
     oasis_digest = Some "Q\202Ry\239l+t\156\004\162\245\197Di\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
